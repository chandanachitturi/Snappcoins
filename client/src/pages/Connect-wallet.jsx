...
const Connect=() =>{
	...
	<header class="header clearfix element_to_stick">
	    ...
	    <div class="container">
	       <div class="logo">
	            <a href="index.html">
	                <img src="img/logo.svg" alt="" width="170" height="35" class="dark" />
	                <img src="img/logo-light-mode.svg" alt="" width="170" height="35" class="light" />
	            </a>
	        </div>
	        <ul class="top_menu">
	        	<li>
	            ...
	            <div class="container">
	                <div class="row justify-content-center">
	                    <div class="col-xl-8 col-lg-10 col-md-8">
	                        <h1 class="slide-animated one">Connect your Wallet</h1>
	                        <p class="slide-animated two">Vim te audiam impetus interpretaris impedit</p>
	                    </div>
	                </div>
	        ...
	        <div class="row justify-content-center">
	            <div class="col-lg-4">
	                <a href="#0" class="box_general wallet_connect">
	                    ...
	                    <figure><img src="img/meta_mask_logo.svg" alt="" width="80" height="80" /></figure>
	                    <h3>A23 Rummy</h3>
	            ...
	            <div class="col-lg-4">
	                <a href="#0" class="box_general wallet_connect">
	                    <figure><img src="img/wallet_connect.svg" alt="" width="80" height="80" /></figure>
	                    <h3>Call Break</h3>
	                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque.</p>
	                </a>
	            </div>
	            <div class="col-lg-4">
	                <a href="#0" class="box_general wallet_connect">
	                    <figure><img src="img/fortmatic.svg" alt="" width="80" height="80" /></figure>
	                    <h3>Ludo King</h3>
	                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque.</p>
	                </a>
	            </div>
