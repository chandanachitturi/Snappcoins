	                    ...
	                    <ul>
	                        <li>
	                            <Link to="author.html" className="author">
	                                <div className="author_thumb veryfied"><i className="bi bi-check"></i>
	                                    <figure>
	                                        <img src="assets/img/avatar-placeholder.png" data-src="assets/img/avatar4.jpg" alt="" className="lazy" width="100" height="100" /></figure>
	                                </div>
	                               <h6>Brand Name</h6>
	                            </Link>
	                        </li>
	                    ...
	                    <ul>
	                        <li>
	                            <Link to="author.html" className="author">
	                                <div className="author_thumb">
	                                    <figure>
	                                        <img src="assets/img/avatar-placeholder.png" data-src="assets/img/avatar1.jpg" alt="" className="lazy" width="100" height="100" /></figure>
	                                </div>
	                               <h6>Brand Name</h6>
	                            </Link>
	                        </li>
	                    ...
	                    <ul>
	                        <li>
	                            <Link to="author.html" className="author">
	                                <div className="author_thumb veryfied"><i className="bi bi-check"></i>
	                                    <figure>
	                                        <img src="assets/img/avatar-placeholder.png" data-src="assets/img/avatar3.jpg" alt="" className="lazy" width="100" height="100" /></figure>
	                                </div>
	                              <h6>Brand Name</h6>
	                            </Link>
	                        </li>
